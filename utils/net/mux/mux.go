...
func (mux *Mux) Listen(needBytesNum uint32, fn MatchFunc) net.Listener {
	ln := &listener{
...
func (mux *Mux) ListenHttp() net.Listener {
	return mux.Listen(HttpNeedBytesNum, HttpMatchFunc)
}

func (mux *Mux) ListenHttps() net.Listener {
	return mux.Listen(HttpsNeedBytesNum, HttpsMatchFunc)
}
